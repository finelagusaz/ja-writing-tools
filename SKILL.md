...
| モード       | トリガー例                                         | 出力                                  |
|--------------|----------------------------------------------------|---------------------------------------|
| 詳細         | 「しっかり校正して」「全部チェック」               | 全カテゴリの指摘 + 修正版テキスト     |
| 標準         | 「校正して」「チェックして」                       | 確信度：高・中の指摘 + 修正版テキスト |
...
| 箇所   | 表記           | 確認事項                             |
|--------|----------------|--------------------------------------|
| 会話文 | 「全然大丈夫」 | 口語表現として意図的であれば問題なし |

---

## 修正版

（確信度：高の項目を反映、表記揺れは多数派に統一）
...
| references/custom-terms.md      | ユーザー固有の用語集（編集可能）       |
